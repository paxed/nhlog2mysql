...
my $xlogfile = "/opt/nethack/nethack.alt.org/nh343/var/xlogfile";
my $fh;
my $line;
my $xlogline;
my $oneline;
...
sub insertxlogline
{
	...
	$dbh->do("insert into xlogfile (version,points,deathdnum,deathlev,maxlvl,hp,maxhp,deaths,deathdate,birthdate,uid,"
		."role,race,gender,align,name,death,conduct,turns,achieve,realtime,starttime,endtime,gender0,align0,nconducts,nachieves,flags) values ("
